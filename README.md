...
Learning React by creating a Apple iPhone Landing Page.
...
- Point 4: Three.js and building a 3D interactive website.
...
1. Clone the repo
   ```sh
   git clone https://github.com/Coder-IsiahJones/react-apple-website.git
   ```
